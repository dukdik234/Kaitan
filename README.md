            ...
            spawn(function()
                ...
                function saber()
                    for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do
                        if game:GetService("Players").LocalPlayer.Data.Level.Value == 200 or game:GetService("Players").LocalPlayer.Data.Level.Value <= 200 then 
                            _G.saber = true
                            while wait() do
                                pcall(function()
                                    local Level = game.Players.LocalPlayer.Data.Level.Value
                                    if _G.saber and not v.Name == "Saber" then 
                ...
                spawn(function()
                    while wait() do
                        if _G.start then
                            pcall(function()
                                game.Players.LocalPlayer.Humanoid:SetStateenabled(15,false)
                            end)
                        end
                    end
                end)
